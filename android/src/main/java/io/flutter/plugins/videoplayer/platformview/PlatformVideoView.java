...
//import io.flutter.plugins.videoplayer.spherical.SphericalGLSurfaceView;
...
public final class PlatformVideoView implements PlatformView {
  @NonNull private final SphericalGLSurfaceView surfaceView;
  ...
  public PlatformVideoView(@NonNull Context context, @NonNull ExoPlayer exoPlayer) {
    var view = new SphericalGLSurfaceView(context);
    view.setDefaultStereoMode(C.STEREO_MODE_STEREO_MESH);

    surfaceView = view;

    // 手动触发 onResume，注册陀螺仪传感器
    view.onResume();
