...
/* package */ final class Projection {
  ...
  public static Projection createEquirectangular(@StereoMode int stereoMode) {
     ...
     * @param stereoMode A {@link StereoMode} value.
     */
    public static Projection createEquirectangular180(@StereoMode int stereoMode) {
        return createEquirectangular(
                /* radius= */ 50,
                /* latitudes= */ 36,
                /* longitudes= */ 36, // 半球横向跨度减半，这里填36即可，性能更好
                /* verticalFovDegrees= */ 180,
                /* horizontalFovDegrees= */ 180, // 【关键修改】从 360 改为 180，生成一个半球
                stereoMode);
    }
