 ...
 */
/* package */ @UnstableApi final class TouchTracker extends GestureDetector.SimpleOnGestureListener
  ...
  public TouchTracker(Context context, Listener listener, float pxPerDegrees) {
    ...
    roll = VRView.UPRIGHT_ROLL;

    System.out.println("初始化 TouchTracker");
  }
